...
<html>
  ...
  <body>
  	<?php 
  		if(isset($_GET['maker'])) $sql = "SELECT * FROM cars WHERE maker='" .$_GET['maker']. "'";
  		else $sql = "SELECT * FROM cars";
  		$result = mysqli_query($link, $sql);
		$num_row = mysqli_num_rows($result);
  	?>
  	<div><a href="second.php">All</a>|<a href="second.php?maker=Toyota">Toyota</a>|<a href="second.php?maker=BMW">BMW</a>
    <div class="cars">
      	<?php 
      		for ($i = 0; $i < $num_row; $i++) {
